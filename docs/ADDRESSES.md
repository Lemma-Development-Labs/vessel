...
```
# Shipped hashes
# TX_KURU_SPOT   <pending>   —   2026-09-07 recheck: MON-USDC bestAsk=0 @ block 60533271 (was 59560667); no DEPLOYER_PK in this agent env
# PERPL_KEEPER_ORDER  <pending>  —  2026-09-07 recheck: no PERPL_API_KEY / PERPL_API_KEY_SECRET in agent env; keeper/ unit tests green; see keeper/README.md
